...
const Contact = () => {
    ...
    return (
        <div className="parent py-24 mt-4">
            ...
            >
                <h3 className="text-neutral text-center">Kontak</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                ...
                >
                    <div className="flex items-center my-6">
                        ...
                        <h3 className="font-medium text-primary">PT. Humpus Karbometil Selulosa</h3>
                    </div>
                    <div className="flex items-center my-6">
                        <FaPhoneAlt className="text-2xl mr-8 text-primary cursor-pointer duration-300"></FaPhoneAlt>
                        <h3 className="font-medium text-primary">021-044</h3>
                    </div>
                    <div className="flex items-center my-6">
                        <MdEmail className="text-3xl mr-8 text-primary cursor-pointer duration-300"></MdEmail>
                        <h3 className="font-medium text-primary">info@hks.com</h3>
                    </div>
                    <div className="flex items-center my-6">
