...
//     const handleSubmit = async (e) => {
//         e.preventDefault();
//         // Check if passwords match before dispatching the action
//         if (password === confPassword) {
//             try {
//                 // Dispatch the changePassword action and handle success
//                 const response = await dispatch(changePassword(user.id, { password }));
//                 Swal.fire({
//                     icon: 'success',
//                     title: 'Berhasil',
