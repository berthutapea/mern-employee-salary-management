...
const DataGajiPegawai = () => {
  ...
  const handleSearch = async () => {
    ...
    const viewGajiSinglePegawaiByYear = async (dataYear) => {
      try {
        const response = await axios.get(`http://localhost:5000/data_gaji/year/${dataYear}`);
        const data = response.data;
        return data
      } catch (error) {
    ...
    const viewGajiSinglePegawaiByMonth = async (dataMonth) => {
      try {
        const response = await axios.get(`http://localhost:5000/data_gaji/month/${dataMonth}`);
        const data = response.data;
        return data
      } catch (error) {
        if (error.response && error.response.data) {
    ...
    const viewGajiSinglePegawaiByName = async (nama_pegawai) => {
      try {
        const response = await axios.get(`http://localhost:5000/data_gaji/name/${nama_pegawai}`);
        const data = response.data;
        return data
